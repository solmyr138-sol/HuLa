...
public class TestGatewayLogin {
    public static void main(String[] args) throws Exception {
        ...
        // Use account=13333333333, password=123456a, grantType=PASSWORD, systemType=2
        String body = "{\"account\":\"13333333333\",\"password\":\"123456a\",\"systemType\":2,\"deviceType\":\"ANDROID\",\"grantType\":\"PASSWORD\",\"key\":\"\",\"code\":\"\"}";
        ...
        if (loginResp.contains("\"token\":\"")) {
            ...
            // Step 2: Call IM service with the new token
            ...
            System.out.println("\n=== IM MSG LIST RESPONSE ===");
            System.out.println("HTTP " + imCode);
            String imResp = imSb.toString();
            System.out.println(imResp.length() > 500 ? imResp.substring(0, 500) + "..." : imResp);
        }
    }
}