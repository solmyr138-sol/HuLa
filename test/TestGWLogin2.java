...
public class TestGWLogin2 {
    public static void main(String[] args) throws Exception {
        ...
        String body = "{\"account\":\"13333333333\",\"password\":\"123456a\",\"systemType\":2,\"deviceType\":\"MOBILE\",\"grantType\":\"PASSWORD\",\"key\":\"\",\"code\":\"\"}";
        ...
        System.out.println("=== LOGIN RESPONSE (HTTP " + code + ") ===");
        ...
        if (loginResp.contains("\"token\":\"")) {
            ...
            if (imIs == null) { System.out.println("IM response stream is null, HTTP " + imCode); return; }
